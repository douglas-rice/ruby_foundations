...
# they can be different objects. The "under the hood" object referred 
# to by a particular named-variable can change depending on what is 
# done to that named-variable.
